function makeFooter() {
    ...
    footer.innerHTML = `
    <div class="bg-gray-200 flex h-0.5"></div>
    <div class="flex justify-center bg-gray-100 dot-bg">
        <div class="flex flex-col align-center justify-between margins-x w-[100%] max-w-[1440px]">
            
            <div class="flex justify-between sm:justify-start gap-x-8 py-20 text-base text-gray-400 mono uppercase">
